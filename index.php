...
<?php
$query = $dbCo->prepare("SELECT article_title, article_content, article_date, article_img FROM article");
$query->execute();
...
foreach ($results as $result) {
  echo '<li>
        <span data-name-id="' . $result['article_title'] . '">' . $result['article_content'] . '</span>
